...
const HeroSection = () => {
  return (
    ...
    />
          ...
          Empowering businesses to thrive securely in the digital age, I merge the worlds of cybersecurity and full-stack development. Safeguarding your online assets is not just a profession, but a mission. Let's fortify your digital presence, together.
          </p>
